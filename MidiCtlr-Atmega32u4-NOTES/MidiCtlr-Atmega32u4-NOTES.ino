...
----------------
  ...
  1/ code modifié pour que les entrées digitales envoies des notes.
    les entrées analogiques A0 à A5 == CC1 à 6 / entrees digitales 2 à 7 == C2 à F#2.
  2/ penser à changer le nombres d'entrees analogiques. Sinon on a des parasites qui font moduler toutes les entrees.
